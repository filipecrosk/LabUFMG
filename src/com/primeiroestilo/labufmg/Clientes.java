...
public class Clientes extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dbHelper = new ClientesAdapter(this);
        dbHelper.open();
        
        Cursor clientes = dbHelper.fetchAllClientes();
		startManagingCursor(clientes);
		
    	if (clientes.getCount() > 0 ){
            //cria cursor que será exibido na tela, nele serão exibidos 
            //todos os contatos cadastrados
            dataSource = new SimpleCursorAdapter(this, R.layout.row_clientes, clientes, 
            		new String[] {"proprietario","_id","propriedade"}, new int[] { R.id.TextNome });
            ...
            dataSource.setFilterQueryProvider(new FilterQueryProvider() {
                 ...
                 public Cursor runQuery(CharSequence constraint) {
                    ...
                    return dbHelper.ClientesFetchBusca(partialValue);
